...
const ArtistDetail = () => {
  ...
  return (
    <div className="bg-gradient-to-b overflow-hidden h-full from-yellow-500 via-purple-500 to-blue-500 dark:from-dark-700 dark:to-gray-900">
      <div className="flex sm:w-1/3 w-2/3 mx-auto my-5">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start w-2/3 mx-auto h-2/3 overflow-auto aslinur">
        {/* ALBUMS */}
        ...
        {/* TRACKS */}
        <div className="flex flex-col items-center md:w-1/2 md:ml-6 h-1/2 sm:h-full overflow-auto aslinur">
          <h2 className="font-bold text-2xl p-4 uppercase italic ">
            Top Tracks
          </h2>
          <div className="grid grid-cols-2 md:grid-cols-2 gap-4">
